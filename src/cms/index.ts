...
const blogPosts: BlogPost[] = [
  ...
  {
    id: '2',
    title: '10 Tips for Maximizing Your Earnings as a Bodaguy Driver in Kampala',
    ...
    content: `
      ...
      <h2>1. Learn the City's Rhythm</h2>
